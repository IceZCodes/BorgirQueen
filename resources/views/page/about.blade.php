...
@section('content')
    ...
    <div class="flex bg-[#FEFAF5]">
        ...
        <div class="w-full">
            <div class="pt-4 pl-2 font-bold text-4xl">
    ...
    <div class="flex">
        <div class="w-full">
            ...
            <div class="pt-4 text-red-600 font-bold text-center w-full text-10xl pr-3">
                SIMPLY TASTY!
            </div>
            ...
            <div class="flex text-white font-bold pt-2 w-full h-full ml-9 mr-12">
                ...
                <div class="pl-2">
                    <button class="bg-red-600 rounded-3xl px-5 py-2">
                        Order Now
                    </button>
                </div>
            </div>  
