            ...
            <div class="flex shadow-md my-10">
                ...
                <div class="sticky w-2/5 px-8 py-10 bg-blue-200">
                    ...
                    class="p-2 text-sm w-full" value="{{$address}}" style="outline: none">
                        ...
                        <dialog class="popup" id="popup" style="position: absolute; top: 50%; left: 30%; transform: translate(-50%, -50%); width: 600px; padding: 20px; background: white; border-radius: 10px; margin-top: -25px; padding-top: 50px; padding-bottom: 75px; ">
