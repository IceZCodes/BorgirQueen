                                                    ...
                                                    <td
                                                        ...
                                                        <div class="flex flex-row gap-2 text-[#F2F2F2]">
                                                            @if ($order->status == 'Preparing')
                                                                <div
                                                                    class="font-semibold bg-[#6FCF97] border border-[1px] border-[#E5E7EB] rounded-lg px-3 py-2">{{ $order->status }}</div>
                                                            @elseif ($order->status == 'OnDelivery')
                                                                <div
                                                                    class="font-semibold bg-[#9B51E0] border border-[1px] border-[#E5E7EB] rounded-lg px-3 py-2">{{ $order->status }}</div>
                                                            @else
                                                                <div
                                                                    class="font-semibold bg-[#2D9CDB] border border-[1px] border-[#E5E7EB] rounded-lg px-3 py-2">{{ $order->status }}</div>
                                                            @endif
                                                        </div>
                                                    </td>
                                                </tr>
