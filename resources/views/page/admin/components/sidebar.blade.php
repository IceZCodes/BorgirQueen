<div class="mt-8 px-4">
    ...
    @else
    <a href="/admin" class="flex items-center text-sm font-normal cursor-pointer py-2 px-2 rounded-lg hover:bg-[#F5F3FF] hover:text-[#7C3AED] mb-1">
        <span class="pr-2"><img src="{{ asset('assets/admin/burger.png') }}" alt=""></span>
        Products
    </a>
    @endif
    ...
    @if ($active == 'customers')
    <a href="/admin/customers" class="flex items-center text-sm font-normal py-2 px-2 rounded-lg bg-[#F5F3FF] text-[#7C3AED] mb-1">
        <span class="pr-2"><img src="{{ asset('assets/admin/users.png') }}" alt=""></span>
        All Customers
    </a>
    @else
    <a href="/admin/customers" class="flex items-center text-sm font-normal cursor-pointer py-2 px-2 rounded-lg hover:bg-[#F5F3FF] hover:text-[#7C3AED] mb-1">
        <span class="pr-2"><img src="{{ asset('assets/admin/users.png') }}" alt=""></span>
        All Customers
    </a>
    @endif
    ...
    @if ($active == 'orders')
    <a href="/admin/orders" class="flex items-center text-sm font-normal py-2 px-2 rounded-lg bg-[#F5F3FF] text-[#7C3AED] mb-1">
        <span class="pr-2"><img src="{{ asset('assets/admin/cash.png') }}" alt=""></span>
        Customer Orders
    </a>
    @else
    <a href="/admin/orders" class="flex items-center text-sm font-normal cursor-pointer py-2 px-2 rounded-lg hover:bg-[#F5F3FF] hover:text-[#7C3AED] mb-1">
        <span class="pr-2"><img src="{{ asset('assets/admin/cash.png') }}" alt=""></span>
        Customer Orders
    </a>
    @endif
